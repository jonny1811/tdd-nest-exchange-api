...
describe('CurrenciesService', () => {
  ...
  describe('getCurrency()', () => {
    it('should be throws if repository throw', async () => {
    ...
    it('should be not throws if repository returns', async () => {
    ...
    it('should be return when repository returns', async () => {
      (repository.getCurrency as jest.Mock).mockResolvedValue({ currency: 'USD', value: 1 });
